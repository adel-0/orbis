...
from utils.constants import DEFAULT_MAX_CONCURRENT_REQUESTS
...
class AzureDevOpsClient(AzureDevOpsAuthMixin):
    ...
    def __init__(self, organization: str, project: str, auth_token: str = None,
        ...
        # Parallel processing settings from constants
    ...
    def from_data_source(cls, data_source) -> 'AzureDevOpsClient':
        ...
        if auth_type == "pat":
            return cls(
                ...
                auth_token=data_source.config.get('pat'),
                use_oauth2=False
            )
            ...
            return cls(
                ...
                client_secret=data_source.config.get('client_secret'),

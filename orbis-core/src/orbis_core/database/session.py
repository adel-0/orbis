"""
Database session management for Orbis applications.
"""
...
# Base class for declarative models - apps can use this or their own
...
class DatabaseManager:
    ...
    def set_base(cls, base) -> None:
        """Set the declarative base for table creation"""
        cls._base = base

    @classmethod
    def init_database(cls, database_url: str | None = None, default_db_name: str = "orbis.db") -> None:
        ...
        if database_url is None:
            ...
            if env_url:
                ...
                database_url = f"sqlite:///data/database/{default_db_name}"
        ...
        # Create all tables if base is set

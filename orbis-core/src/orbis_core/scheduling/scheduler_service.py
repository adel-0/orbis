"""
Generic task scheduler service for automated data ingestion.
Handles scheduling of data ingestion and embedding generation tasks.
"""
...
class DataIngestionService(Protocol):
    """Protocol for data ingestion services that can be scheduled"""
...
class SchedulerService:
    """Generic service for scheduling automated tasks"""

    def __init__(
        self,
        data_ingestion_service: DataIngestionService | None = None,
        ...
        Args:
            data_ingestion_service: Service that implements ingest_all_sources method
            schedule_enabled: Whether scheduling is enabled
            schedule_time: Time to run in HH:MM format (default: "02:00")
            schedule_interval_hours: Interval between runs in hours (default: 24)
        """
